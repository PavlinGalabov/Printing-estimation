# Generated by Django 5.0.14 on 2025-07-19 22:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "waste_sheets",
                    models.PositiveIntegerField(
                        blank=True, help_text="Additional sheets for waste", null=True
                    ),
                ),
                (
                    "sheets_to_buy",
                    models.PositiveIntegerField(
                        blank=True, help_text="Total sheets to purchase", null=True
                    ),
                ),
                (
                    "paper_weight_kg",
                ...
                (
                    "is_template",
                    models.BooleanField(
                        default=False, help_text="Use this job as a template"
                    ),
                ),
                (
                    "template_name",
        ...
        migrations.AddIndex(
            model_name="job",
            index=models.Index(
                fields=["status", "is_template"], name="jobs_job_status_d3cd68_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="job",
            index=models.Index(
                fields=["created_by", "created_at"], name="jobs_job_created_197740_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="job",
            index=models.Index(
                fields=["order_type"], name="jobs_job_order_t_eb7207_idx"
            ),
        ),
